...
This repo contains the notebook behind my blog post **“From Panic Trade to Math: Choosing a 1DTE Put with Risk Aversion.”**  
It’s a small, practical experiment: if you’re going to take a short-dated options bet, can you choose a *less bad* entry price using risk-aware decision rules instead of vibes?
...
- **Certainty Equivalent (CE)** as a simple risk-aversion filter  
  \[
